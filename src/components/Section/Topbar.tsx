...
export default function Topbar() {
  ...
  // Manejo de scroll suave al hacer clic en anchors como /#mision
  function handleAnchorClick(
    ...
    if (href?.startsWith("/#") || href?.startsWith("#")) {
      ...
      if (el) {
        e.preventDefault(); // evita navegación brusca
      ...
      <nav className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
        ...
        <ul className="hidden md:flex gap-8 text-sm text-slate-600 items-center">
          ...
          <li className="relative group">
            ...
            <ul className="absolute left-0 top-full mt-2 hidden w-48 rounded-md border border-slate-200 bg-white py-2 shadow-lg group-hover:block z-20">
              <li><a href="/#mision" className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100" onClick={handleAnchorClick}>Misión y Visión</a></li>
              <li><a href="/#objetivos" className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100" onClick={handleAnchorClick}>Objetivos</a></li>
              <li><a href="/#contacto" className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-100" onClick={handleAnchorClick}>Contacto</a></li>
            </ul>
          </li>
      ...
      {menuOpen && (
        <div className="md:hidden border-t border-slate-200 bg-white px-6 py-4">
          <ul className="space-y-2 text-slate-700 text-sm">
            ...
            <li>
              ...
              {submenuOpen && (
                <ul className="mt-2 space-y-1 pl-4">
                  <li>
                    <a href="/#mision" onClick={(e) => handleAnchorClick(e, () => setMenuOpen(false))}>
                      Misión y Visión
                    </a>
                  </li>
                  <li>
                    <a href="/#objetivos" onClick={(e) => handleAnchorClick(e, () => setMenuOpen(false))}>
                      Objetivos
                    </a>
                  </li>
                  <li>
                    <a href="/#contacto" onClick={(e) => handleAnchorClick(e, () => setMenuOpen(false))}>
                      Contacto
                    </a>
                  </li>
                </ul>
            ...
            <li><Link to="/contacto" onClick={() => setMenuOpen(false)}>Resources</Link></li>
          </ul>
        </div>
      )}
    </header>
